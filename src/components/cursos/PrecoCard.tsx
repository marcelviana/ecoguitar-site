      ...
      <div className="p-8 lg:p-10">
        {preco && (
          <div className="mb-6">
            ...
            {precoIndividual && (
              <p className="font-sans text-small text-eco-muted mt-0.5">
        ...
        <dl className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8">
          {duracao && (
            <div>
              <dt className="font-mono text-label uppercase tracking-widest text-eco-muted">Duração</dt>
          ...
          {maxAlunos && (
            <div>
              <dt className="font-mono text-label uppercase tracking-widest text-eco-muted">Turma</dt>
        ...
        <a
          ...
          className="inline-flex items-center justify-center w-full font-sans font-medium transition-colors duration-200 bg-eco-wood text-white hover:bg-eco-wood-dark px-6 py-4 text-body"
        >
          Quero me inscrever
        </a>
      </div>
