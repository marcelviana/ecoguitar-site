  ...
  return (
    <div className="flex flex-col bg-eco-night border border-eco-border rounded-xl overflow-hidden">
      ...
      <div className="flex flex-col gap-4 p-6">
        <div>
          <h3 className="font-serif text-title text-eco-night">{instrumento.nome}</h3>
          {instrumento.descricao && (
            <p className="font-sans text-small text-eco-sky mt-1 line-clamp-2">{instrumento.descricao}</p>
          )}
        </div>
        <Link
          href="/instrumentos"
          className="inline-flex items-center gap-1 font-sans text-small text-eco-turquoise hover:underline underline-offset-4 transition-colors"
        >
          Ver detalhes →
        </Link>
      </div>
    ...
    <section className="bg-eco-sand-warm py-section">
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        <div className="flex flex-col items-center text-center mb-16">
          ...
          <h2 className="font-serif text-headline text-eco-night mt-3">Instrumentos</h2>
        </div>
