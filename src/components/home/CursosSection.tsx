    ...
    <div className="flex flex-col bg-eco-paper border border-eco-border rounded-xl overflow-hidden">
      ...
      <div className="flex flex-col gap-4 p-6 flex-1">
        <div className="flex-1">
          ...
          <h3 className="font-serif text-title text-eco-charcoal mt-1">{curso.titulo}</h3>
          {curso.descricao && (
            <p className="font-sans text-small text-eco-muted mt-2 line-clamp-2">{curso.descricao}</p>
          )}
          {curso.preco && (
            <p className="font-mono text-small text-eco-wood mt-3">{curso.preco}</p>
          )}
        </div>
    ...
    <section className="bg-eco-cream py-section">
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        <div className="flex flex-col items-center text-center mb-16">
          <SectionLabel>Aprenda lutheria</SectionLabel>
        ...
        <div className="mt-12 text-center">
          <Link
            href="/cursos"
            className="font-sans text-body text-eco-wood hover:underline underline-offset-4 transition-colors"
          >
            Ver todos os cursos →
          </Link>
        </div>
