          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24">
            ...
            <div className="flex flex-col gap-8">
              <div>
                ...
                <h1 className="font-serif text-headline text-eco-charcoal mt-3">Contato</h1>
                <p className="font-sans text-body-lg text-eco-muted mt-4">
              ...
              <div className="flex flex-col gap-6">
                <div className="flex items-start gap-4">
                  <div className="mt-1 flex-shrink-0 w-10 h-10 rounded-full bg-eco-wood/10 flex items-center justify-center">
                    <svg aria-hidden="true" className="w-5 h-5 text-eco-wood" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <div>
                    <p className="font-mono text-label uppercase tracking-widest text-eco-muted">Localização</p>
                    <p className="font-sans text-body text-eco-charcoal mt-1">São Paulo — SP</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  <div className="mt-1 flex-shrink-0 w-10 h-10 rounded-full bg-eco-wood/10 flex items-center justify-center">
                    <svg aria-hidden="true" className="w-5 h-5 text-eco-wood" viewBox="0 0 24 24" fill="currentColor">
            ...
            {/* Formulário */}
            <div className="bg-eco-paper border border-eco-border rounded-2xl p-8 lg:p-10">
              <ContatoForm />
            </div>
          </div>
        </div>
